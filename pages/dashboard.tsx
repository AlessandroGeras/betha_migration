...
import OutsourcedComponent from '../components/outsourced';
...
const Dashboard = () => {
    ...
    const [isViewOutsourcedOpen, setIsViewOutsourcedOpen] = useState(false);
            ...
            <div className="bg-white flex flex-col items-center">
                ...
                <div className="mb-8 w-full">
                    ...
                    <div className="px-6 py-3 py-2 cursor-pointer group hover:bg-blue-500" onMouseEnter={toggleSubMenuCadastros} onMouseLeave={toggleSubMenuCadastros}>
                        ...
                        {isSubMenuOpenCadastros && <div className="absolute top-[166px] left-[80px] bg-white shadow-md">
                            <button className='hover:bg-blue-500 hover:text-white px-12 py-[9.5px]' onClick={terceirosClick}>Terceiros</button>
                            <br></br>
                            <button className='hover:bg-blue-500 hover:text-white px-12 py-[9.5px]'>Funções</button>
                            <br></br>
                            <button className='hover:bg-blue-500 hover:text-white px-8 py-[9.5px]'>Tipos de doc</button>
                        </div>}
                    </div>
                ...
                <div className='mt-auto'>
                    <div className="pl-[32.5px] pr-2 py-3 cursor-pointer group hover:bg-blue-500" onMouseEnter={toggleSubMenuConta} onMouseLeave={toggleSubMenuConta}>
                        ...
                        {isSubMenuOpenConta && <div className="absolute top-[589.5px] left-[80px] bg-white px-8 py-[9.5px] shadow-md hover:bg-blue-500 hover:text-white">
                            <p>Minha Conta</p>
                        </div>}
                    </div>
