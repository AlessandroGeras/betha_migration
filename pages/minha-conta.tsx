    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const minha_contaResponse = await fetch(`/api/minha-conta`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
                ...
                const minha_conta = await minha_contaResponse.json();

                setFormData({
                    usuario: minha_conta.usuario.usuario,
                    nome: minha_conta.usuario.nome,
                    email: minha_conta.usuario.email,
                    id: minha_conta.usuario.id,
                });
