    ...
    if (user) {
      ...
      await transporter.sendMail({
        ...
        html: `<p>Instruções para recuperação de senha do Portal Gestão de Terceiro:</p>
               ...
               <p><a href="https://gestao-terceiros.estilofontana.com.br/password-reset?token=${token}" style="color: #3498db; text-decoration: none; font-weight: bold;">Redefinir Senha</a></p>
