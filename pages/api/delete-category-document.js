...
export default async function handler(req, res) {
  if (req.method === 'POST') {
    ...
    try {
      ...
      const outsourcedFound = await documents.findOne({
        where: {
          TIPO_DOCUMENTO: categoria // Especifique os critérios de busca aqui
        }
      });
      ...
      // Exclua o usuário
      await connection.query(`DELETE FROM CATEGORIA_DOCUMENTOS WHERE CATEGORIA = :categoria`, {
