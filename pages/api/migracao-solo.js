...
WHERE lc.cd_exercicio = 2024 AND lc.nr_mes = 7
        ...
        const transformedData = resultData.map(record => ({
            ...
            modalidadeLegal: {
                valor: record.valor.toUpperCase(),
                descricao: "string" // Ajustar conforme necessário
            },
            sigla: record.sigla.replace(/-/g, ''), // Remove hyphens
            valorCompras: record.valorCompras,
            valorObras: 0 // Ajustar conforme necessário
        }));
