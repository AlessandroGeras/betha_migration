...
JSON_QUERY(
        (SELECT
SUBSTRING(CAST(cd_InscricaoImovel AS VARCHAR(10)), 1, 3) AS campo1,
SUBSTRING(CAST(cd_InscricaoImovel AS VARCHAR(10)), 4, 3) AS campo2,
SUBSTRING(CAST(cd_InscricaoImovel AS VARCHAR(10)), 7, 4) AS campo3,
...
where (o.cd_Observ = 1 or o.cd_Observ is null) and (i.cd_Imovel = 116 or i.cd_Imovel = 199 or i.cd_Imovel = 488 or i.cd_Imovel = 489)
    ...
    .map(record => {
        ...
        return {
            ...
            imoveis: {
                campo1: imoveis.campo1 ? imoveis.campo1.slice(0, 10) : null,
                campo2: imoveis.campo2 ? imoveis.campo2.slice(0, 10) : null,
                campo4: imoveis.campo3 ? imoveis.campo3.slice(0, 10) : null,
                apartamento: imoveis.apartamento,
                idBairro: imoveis.idBairro,
                cep: imoveis.cep,
                complemento: imoveis.complemento,
                idImovel: imoveis.idImovel,
                lote:imoveis.lote | null,
                setor:imoveis.setor,
                complemento:imoveis.complemento || null,
                ...
                setor: imoveis.setor,
                inscricaoIncra:imoveis.inscricaoIncra,
                nroImovel: imoveis.nroImovel !== "" ? imoveis.nroImovel : "0"
            }
        };
    });
        ...
        // Enviar cada registro individualmente para a rota desejada
          for (const record of transformedData) {
            ...
            const responseBody = await response.json(); // Capturar o corpo da resposta

            if (response.ok) {
                console.log(`Dados do registro enviados com sucesso. Resposta da API:`, responseBody);
            } else {
                console.error(`Erro ao enviar os dados do registro para a API:`, response.statusText, responseBody);
            }
        } 
