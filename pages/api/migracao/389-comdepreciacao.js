...
JSON_QUERY((SELECT JSON_QUERY((SELECT '1983' as id FOR JSON PATH, WITHOUT_ARRAY_WRAPPER)) AS metodoDepreciacao,
...
bp.vl_aquisicao as vlAquisicao,
 ...
 case when (BP.vl_anterior - BP.vl_atual) = 0 then BP.vl_aquisicao else (BP.vl_aquisicao - BP.vl_residual - (BP.vl_anterior - BP.vl_atual)) end as vlDepreciavel, --vlAquisicao - vlresidual - vldepreciado
(BP.vl_anterior - BP.vl_atual) as vlDepreciado, -- vl_depreciacao
...
where BP.cd_situacao = 1 and bp.dt_aquisicao < ('2024-01-01 00:00:00') and BP.cd_EntidadeContabil = 1 and pc_residual > 0  and BP.vl_anterior > 0 --com depreciação
