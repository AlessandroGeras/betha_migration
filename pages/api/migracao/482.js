...
JSON_QUERY((SELECT a.cd_alteracaoorcamentaria as numero,
                                   ...
                                   JSON_QUERY((SELECT 23371 as id FOR JSON PATH, WITHOUT_ARRAY_WRAPPER)) AS tipo,
                                   JSON_QUERY((SELECT 24157 as id FOR JSON PATH, WITHOUT_ARRAY_WRAPPER)) AS naturezaTextoJuridico,
...
where aa_Lei in (2023,2024,2022,2021,2020)
        `;
