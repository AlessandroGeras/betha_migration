...
--and a.cd_fornecedor = 4
        ...
        const transformedData = resultData.map(record => {
            ...
            // Verificar se o CPF está presente na chave juridica
            const cpf = content.credorReinf && content.credorReinf.juridica ? content.credorReinf.juridica.cpf : null;
            ...
            return {
                ...
                content: {
                    ...
                    fisica: {
                        cpf: cpf ? cpf.replace(/\D/g, '') : null // Remove any non-digit characters from CPF
                    },
