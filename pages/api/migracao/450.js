...
--and a.cd_fornecedor = 4
        ...
        const transformedData = resultData.map(record => {
            ...
            // Check CPF in juridica key and remove non-digit characters
            const cpf = content.credorReinf?.juridica?.cpf?.replace(/\D/g, '') || null;
        
            return {
                idIntegracao: record.idIntegracao.toString(),
                content: {
                    tipo: content.tipo || "FISICA",
