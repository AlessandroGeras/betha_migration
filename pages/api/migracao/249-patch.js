...
JSON_QUERY(
 ...
 when cd_InscricaoImovel = '002015005' then 27629382
								end as id FOR JSON PATH, WITHOUT_ARRAY_WRAPPER)) AS idGerado,
...
`;
        ...
        const transformedData = resultData
            .filter(record => {
                try {
                    ...
                    // Verifica se o campo 'idGerado' existe e se 'idGerado.id' é válido
                    return imoveis.idGerado && imoveis.idGerado.id;
                } catch (error) {
            ...
            .map(record => {
                ...
                return {
                    ...
                    imoveis: {
                        idGerado: {
                            id: imoveis.idGerado.id
                        },
                        campo1: imoveis.campo1,
                        campo2: imoveis.campo2,
                        campo3: imoveis.campo3,
                        ...
                        nroImovel: imoveis.nroImovel !== "" ? imoveis.nroImovel : null,
        ...
        for (const record of transformedData) {
            ...
            const idGerado = record.imoveis?.idGerado?.id; // Verificação de segurança para acessar idGerado

            if (pessoaId && idGerado) { // Verifica se o ID da pessoa e o idGerado são válidos
                try {
                ...
                console.error('ID de pessoa ou idGerado inválido. O registro será ignorado.');
                report.push({ record, status: 'invalid', error: 'ID de pessoa ou idGerado inválido.' });
            }
        }
