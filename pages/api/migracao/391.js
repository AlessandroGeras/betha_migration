...
where BP.cd_situacao = 2 and cd_EntidadeContabil = 1 and f.cd_Cecam = 1995;
        `;
            ...
            return {
                conteudo: {
                    ...
                    bemValor: {
                        ...
                        vlResidual: record.numeroPlaca === '1161' ? 0 : (content.bemValor?.vlResidual || 0), // Se numeroPlaca for 1161, vlResidual é 0
                        moeda: {
