...
when        99999999        then        14114756
 ...
 where cd_fichadesp > 6000  and vl_orcado = 0 and cd_cecam = 1995
 and aa_FichaDesp = 2023
 ) as tot
        `;
        ...
        const transformedData = resultData.map(record => {
            ...
            return {
                ...
                content: {
                    ...
                    programa: {
                        id: content.programa && content.programa.id ? content.programa.id : null
                    },
                    acao: {
                        id: content.acao && content.acao.id ? content.acao.id : null
                    },
                    localizador: {
                        id: content.localizador && content.localizador.id ? content.localizador.id : null
                    },
                    organograma: {
                        id: content.organograma && content.organograma.id ? content.organograma.id : null
                    },
                    funcao: {
                        id: content.funcao && content.funcao.id ? content.funcao.id : null
                    },
                    subfuncao: {
                        id: content.subfuncao && content.subfuncao.id ? content.subfuncao.id : null
                    },
                    natureza: {
                        id: content.natureza && content.natureza.id ? content.natureza.id : null
                    }
                }
            };
        });
