...
dt_PassivoNaoFinanceiroAtualizacaoestorno as data,
vl_PassivoNaoFinanceiroAtualizacaoestorno as valor,
ds_PassivoNaoFinanceiroAtualizacaoestorno as motivo
 FOR JSON PATH, WITHOUT_ARRAY_WRAPPER)
) AS content
from CONTPASSIVONAOFINANCEIROATUALIZACAOESTORNO
        `;
        ...
        const transformedData = resultData.map(record => {
            ...
            // Correção no campo 'motivo'
            const motivo = parsedContent.motivo 
                ? parsedContent.motivo.substring(0, 100)  // Usando o campo 'motivo' corretamente
            ...
            return {
                ...
                content: {
                    ...
                    data: data,
                    valor: valor,
                    motivo: motivo  // Incluindo o motivo no JSON final
                }
            };
        });
