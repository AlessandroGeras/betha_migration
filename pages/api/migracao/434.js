...
where  cd_passivonaofinanceiro < 10
        ...
        const transformedData = resultData.map(record => {
            ...
            const divida = parsedContent.divida && parsedContent.divida.id
                ? { id: parsedContent.divida.id }
                : {};
        ...
        /* for (const record of transformedData) {
            const url = `https://con-sl-rest.betha.cloud/contabil/service-layer/v2/api/acrescimos-dividas`;
