...
async function main() {
    try {
        ...
        const userQuery = `
            select 
cd_categoriaprocesso as id,
ds_categoriaprocesso as descricao
from PNCP_CategoriaProcesso
        `;
        ...
        for (const batch of batchedData) {
            try {
                ...
                const response = await fetch(`https://compras.betha.cloud/compras-services/api/conversoes/lotes/objeto-licitacao`, {
                    method: 'POST',
                    headers: {
