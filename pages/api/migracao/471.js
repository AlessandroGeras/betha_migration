...
and dc.cd_Liquidacao   in (2777,2922,2919)
order by dc.cd_Liquidacao
        ...
        const transformedData = resultData.map(record => {
            try {
                ...
                return {
                    idIntegracao: record.idIntegracao ? record.idIntegracao.toString() : "1", // Default to "1" if missing
                    content: {
                        validaSaldo: content.validaSaldo === "true", // Convert string to boolean
                        exercicio: content.exercicio || 2024, // Default to 2024 if not provided
                        empenho: {
                            id: empenhoId // Use the valid empenho id
                        },
                        data: content.data ? formatDate(content.data) : null, // Format date
                        valor: content.valor || 0, // Default to 0 if not provided
                        especificacao: content.especificacao || "", // Default to empty string if not provided
                        numeroCadastro: content.numeroCadastro || null, // Default to null if not provided
                        ...
                        comprovantes: comprovanteId ? [{
                            comprovante: {
                                id: comprovanteId // Use the valid comprovante id
                            },
