...
and (dt_emissao = '2024-01-01 00:00:00.000' or cd_fichadesp > 5000))
        ...
        const transformedData = resultData.map(record => {
            ...
            return {
                idIntegracao: record.idIntegracao ? record.idIntegracao.toString() : "1", // Definindo "1" como valor padrão
                content: {
                    ...
                    retencoes: content.retencoes ? [{
                        retencao: {
                            id: content.retencoes.retencao && content.retencoes.retencao.id ? content.retencoes.retencao.id : null
                        },
                        valor: content.retencoes.valor || 0, // Usando o valor de retenção ou 0
                        recursos: content.retencoes.recursos ? [{
                            recurso: {
                                id: content.retencoes.recursos.recurso && content.retencoes.recursos.recurso.id ? content.retencoes.recursos.recurso.id : null
                            },
                            valor: content.retencoes.recursos.valor || 0 // Usando o valor dos recursos ou 0
                        }] : []
                    }] : [], // Garantindo que `retencoes` seja um array
                    ...
                    }] : [] // Garantindo que `comprovantes` seja um array
                    // Garantindo que `vencimentos` seja um array
                }
            };
