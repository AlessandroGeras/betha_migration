...
WHERE al.sg_direcao = 'CD' and al.aa_movimento = '2024' and qt_movimento > 0 and fl_devolucao is null and (cd_almoxa = 20100 or cd_almoxa = 20200 or  cd_almoxa = 20300 or  cd_almoxa = 20500 or  cd_almoxa = 20600 or  cd_almoxa = 20800 or  cd_almoxa = 20900 )
        ...
        /* for (const record of transformedData) {
            const response = await fetch('https://services.almoxarifado.betha.cloud/estoque-services/api/conversoes/lotes/entradas', {
                ...
                headers: {
                    ...
                    'Authorization': 'Bearer a366caef-8259-4481-9322-9d96dabdfa91'
                },
