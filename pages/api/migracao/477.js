    ...
    try {
        ...
        (SELECT
            CASE 
                ...
                WHEN nr_pedido = 4 THEN 5878420
                WHEN nr_pedido = 12 THEN 5878420
                WHEN nr_pedido = 18 THEN 5878420
                WHEN nr_pedido = 19 THEN 5878420
                WHEN nr_pedido = 20 THEN 5878420
                WHEN nr_pedido = 21 THEN 5878420
                WHEN nr_pedido = 2 THEN 5878419
                WHEN nr_pedido = 3 THEN 5878419
                WHEN nr_pedido = 5 THEN 5878422
                WHEN nr_pedido = 15 THEN 5878422
                WHEN nr_pedido = 24 THEN 5878422
                WHEN nr_pedido = 40 THEN 5878422
                WHEN nr_pedido = 9 THEN 5878424
                WHEN nr_pedido = 10 THEN 5878424
                WHEN nr_pedido = 11 THEN 5878424
                WHEN nr_pedido = 13 THEN 5878424
                WHEN nr_pedido = 22 THEN 5878424
                WHEN nr_pedido = 23 THEN 5878424
                WHEN nr_pedido = 41 THEN 5878424
                WHEN nr_pedido = 43 THEN 5878424
                WHEN nr_pedido = 6 THEN 5878423
                WHEN nr_pedido = 7 THEN 5878423
                WHEN nr_pedido = 8 THEN 5878423
                WHEN nr_pedido = 14 THEN 5878423
                WHEN nr_pedido = 25 THEN 5878423
                WHEN nr_pedido = 26 THEN 5878423
                WHEN nr_pedido = 29 THEN 5878423
                WHEN nr_pedido = 32 THEN 5878423
                WHEN nr_pedido = 33 THEN 5878423
                WHEN nr_pedido = 42 THEN 5878423
                WHEN nr_pedido = 16 THEN 5878425
                WHEN nr_pedido = 17 THEN 5878425
                WHEN nr_pedido = 44 THEN 5878425
                WHEN nr_pedido = 45 THEN 5878425
