...
JOIN contindicador I ON  i.cd_Indicador = pa.cd_Indicador
                    ...
                    metasFisicas: [
                        {
                            ...
                            localizador: {
                                id: parseInt(parsedContent.metasFisicas.localizador.id, 10)
                            }
                        }
                    ]
                }
        ...
        for (const batch of batchedData) {
            try {
                ...
                const response = await fetch(`https://pla-sl-rest.betha.cloud/planejamento/service-layer/v2/api/grupos-despesas-ldo`, {
                    method: 'POST',
                    headers: {
