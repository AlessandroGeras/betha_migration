...
function formatNumero(numero) {
    ...
    const part4 = '01'; // Quarto agrupamento fixo
...
JSON_QUERY(
    (SELECT
        ...
        concat(cd_divadm1, '.', cd_divadm2, '.', cd_divadm3, '.','01') as numero,
        '4' as nivel,
        case cd_divadm3
