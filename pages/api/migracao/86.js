...
async function main() {
    try {
        ...
        const userQuery = `
            select 
cd_tipoetapaata as id,
ds_tipoetapaata as descricao
from COMPLicitacaoTipoEtapaAta
        `;
        ...
        for (const batch of batchedData) {
            try {
                ...
                const response = await fetch(`https://compras.betha.cloud/compras-services/api/conversoes/lotes/tipos-atas`, {
                    method: 'POST',
                    headers: {
