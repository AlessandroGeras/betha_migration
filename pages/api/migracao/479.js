...
FOR JSON PATH, WITHOUT_ARRAY_WRAPPER)
			...
			JSON_QUERY(
                (
                    SELECT
                        CASE at.cd_DestinacaoRecursoOrigem
...
where t.cd_AlteracaoOrcamentariaTipo in (1)
                ...
                content: {
                    ...
                    origens: content.origens && !Array.isArray(content.origens) 
                        ? [{
                            ...
                            despesa: {
                                id: content.origens.despesa && content.origens.despesa.id ? content.origens.despesa.id : null
                            },
                            valor: content.origens.valor ? parseFloat(content.origens.valor) : null,
                            
                            // Tratamento de recursos dentro de origens (verifica se é objeto ou array)
                        ...
                        : Array.isArray(content.origens) ? content.origens.map(origem => ({
                            ...
                            despesa: {
                                id: origem.despesa && origem.despesa.id ? origem.despesa.id : null
                            },
