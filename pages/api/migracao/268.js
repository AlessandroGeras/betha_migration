...
JSON_QUERY(
    (SELECT
        cd_TipoAvaliacao as id,
        ds_TipoAvaliacao as descricao
 FOR JSON PATH, WITHOUT_ARRAY_WRAPPER)
) AS conteudo
from FOLHTipoAvaliacao
        `;
        ...
        for (const record of transformedData) {
            const response = await fetch('https://pessoal.betha.cloud/service-layer/v1/api/configuracao-avaliacao', {
                method: 'POST',
                headers: {
