...
from FOLHTipoRescisao
        ...
        const transformedData = resultData.map(record => {
            ...
            // Coletando todos os valores do SELECT para o novo modelo JSON
            return {
                ...
                conteudo: {
                    ...
                    tipoAfastamento: {
                        ...
                        descricao: conteudo.tipo, // Mantendo o mesmo valor para simplificação
                        classificacao: conteudo.tipo // Mantendo o mesmo valor para simplificação
                    },
                    tipoMovimentacaoPessoal: {
                        descricao: conteudo.tipoMovimentacaoPessoal.descricao || 'string', // Valor padrão "string" caso esteja vazio
                        classificacao: conteudo.tipoMovimentacaoPessoal.classificacao || 'NENHUMA' // Valor padrão "NENHUMA" caso esteja vazio
                    }
                }
            };
        });
