          ...
          <div className="flex-1" id="Dashboard">
            ...
            {documents.success && (
              <div className=''>
                ...
                <div className="flex flex-col h-[550px] w-[1440px] overflow-y-auto text-overflow: clip ellipsis">
                  {/* Cabeçalho */}
                  ...
                  {documents.docs.rows.map((document: any, index) => (
                    <div className='w-[1440px]' key={document.id || index}>
                      <div
                        className={`flex text-gray-700 whitespace-nowrap w-[2059px] text-overflow: clip ellipsis  ${index % 2 === 0 ? 'bg-gray-100' : 'bg-gray-200'}`}
                      >
                        {Object.keys(columnWidths).map((column) => (
                          <div
                            key={column}
