        ...
        <div className='flex'>
          ...
          <div className="flex-1" id="Dashboard">
            <div className="bg-blue-500 text-white p-2 text-left w-full">
              <span className='ml-2'>Categoria de Documentos</span>
            </div>
                ...
                <div className="loading-content bg-white p-8 mx-auto my-4 rounded-lg w-full h-full relative flex flex-row relative animate-fadeIn">
                  <div className="text-blue-500 text-md text-center flex-grow">
                    <div className="flex items-center justify-center h-full text-4xl">
                      Carregando lista de Categoria de Documentos...
                    </div>
                  </div>
                </div>
              </div>
            ...
            {documents.success && (
              <div className=''>
                ...
                <div className="flex flex-col h-[550px] w-[1440px] overflow-x-scroll overflow-y-auto text-overflow: clip ellipsis">
                  {/* Cabeçalho */}
                  ...
                  {documents.docs.rows.map((document: any, index) => (
                    <div className='w-[1440px]' key={document.id || index}>
                      <div
                        className={`flex text-gray-700 whitespace-nowrap w-[2059px] overflow-x-auto text-overflow: clip ellipsis  ${index % 2 === 0 ? 'bg-gray-100' : 'bg-gray-200'}`}
                      >
                        {Object.keys(columnWidths).map((column) => (
                          <div
                            key={column}
                            ...
                            style={{ width: column === 'CIDADE' ? (pageSize === 10 ? '310px' : '290px') : columnWidths[column] }}
                          >
                            {column === '' ? (<div className='flex justify-center'><Link href={{ pathname: '/find-category-documents', query: { id: document.CATEGORIA } }}>
