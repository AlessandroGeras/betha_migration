        ...
        {documents.success && (
          ...
          {/* LARGURA DA LISTA PRINCIPAL Fixa 1440px*/}
            <div className="flex flex-col h-[550px] w-[1440px] overflow-y-auto overflow-x-auto text-ellipsis overflow-hidden">
              ...
              <div className="flex text-gray-500 bg-white w-[1700px]">
            ...
            {/* LARGURA DO CONTEÚDO INTERNO DA LISTA PRINCIPAL */}
              {documents.docs.rows.map((document, index) => (
                <div className='w-[1700px]' key={document.id || Math.random().toString()}>
                  <div
                    className={`flex text-gray-700 whitespace-nowrap w-[1700px] text-ellipsis overflow-hidden  ${index % 2 === 0 ? 'bg-gray-100' : 'bg-gray-200'}`}
                  >
                    {Object.keys(columnWidths).map((column) => (
                      <div
                        key={column}
