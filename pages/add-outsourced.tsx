...
const AddOutsourced = () => {
    ...
    const [categoriasPrincipaisSelecionadas, setCategoriasPrincipaisSelecionadas] = useState<string[]>([]);
    ...
    const handleAddCategoriaPrincipal = () => {
        if (categoriaPrincipalSelecionada && !categoriasPrincipaisSelecionadas.includes(categoriaPrincipalSelecionada)) {
            setCategoriasPrincipaisSelecionadas((prev) => [...prev, categoriaPrincipalSelecionada]);
                            ...
                            <div className="grid grid-cols-7 gap-4 w-3/4 mx-auto">
                                ...
                                <div className="col-span-4">
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => setCategoriaPrincipalSelecionada(e.target.value)}
                                        required
                                        className="mt-1 p-2 border rounded-md w-full focus:outline-none focus:ring focus:border-blue-300"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="mt-2 px-4 py-2 bg-blue-500 text-white rounded-md focus:outline-none focus:ring focus:border-blue-300"
                                    >
