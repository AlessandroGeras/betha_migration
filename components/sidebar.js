            ...
            <div className="bg-white flex flex-col items-center">
                ...
                <div className="mb-8 w-full">
                    ...
                    <div className="px-6 py-3 py-2 cursor-pointer group hover:bg-blue-500" onMouseEnter={toggleSubMenuHome} onMouseLeave={toggleSubMenuHome}>
                        ...
                        {isSubMenuOpenHome &&
                            <div className="absolute top-[80px] left-[80px] bg-white w-[250px] text-center py-[9.5px] shadow-md hover:bg-blue-500 hover:text-white" onClick={dashboardClick}>
                                <p>Página Inicial</p>
                            </div>}
                    </div>
                    <div className="px-6 py-3 py-2 cursor-pointer group hover:bg-blue-500" onMouseEnter={toggleSubMenuPrestadores} onMouseLeave={toggleSubMenuPrestadores}>
                        ...
                        {isSubMenuOpenPrestadores && <div className='absolute top-[123px] left-[80px] bg-white shadow-md text-center'>
                            <button className="hover:bg-blue-500 hover:text-white block w-[250px] py-[9.5px]" onClick={usuariosClick}><p>Usuários</p></button>
                            <button className="hover:bg-blue-500 hover:text-white block w-[250px] py-[9.5px]" onClick={adicionarUsuariosClick}><p>Incluir Usuários</p></button>
                            </div>}
                    </div>
                    <div className="px-6 py-3 py-2 cursor-pointer group hover:bg-blue-500" onMouseEnter={toggleSubMenuCadastros} onMouseLeave={toggleSubMenuCadastros}>
                        ...
                        {isSubMenuOpenCadastros && <div className="absolute top-[166px] left-[80px] bg-white shadow-md">
                            <button className='hover:bg-blue-500 hover:text-white block w-[250px] py-[9.5px]' onClick={terceirosClick}>Listar Terceiros</button>
                            <button className='hover:bg-blue-500 hover:text-white block w-[250px] py-[9.5px] border-b-2 border-gray-300 ' onClick={adicionarTerceirosClick}>Incluir Terceiro</button>
                            <button className='hover:bg-blue-500 hover:text-white block w-[250px] py-[9.5px]' onClick={categoriasTerceirosClick}>Categorias Terceiro</button>
                            <button className='hover:bg-blue-500 hover:text-white block w-[250px] py-[9.5px] border-b-2 border-gray-300' onClick={addCategoriasTerceirosClick}>Criar Categoria Terceiro</button>
                            <button className='hover:bg-blue-500 hover:text-white block w-[250px] py-[9.5px]' onClick={colaboradoresClick}>Colaboradores de Terceiro</button>
                            <button className='hover:bg-blue-500 hover:text-white block w-[250px] py-[9.5px] border-b-2 border-gray-300' onClick={adicionarColaboradoresClick}>Adicionar Colaborador</button>
                            <button className='hover:bg-blue-500 hover:text-white block w-[250px] py-[9.5px]' onClick={categoriasColaboradoresClick}>Categorias Colaborador</button>
                            <button className='hover:bg-blue-500 hover:text-white block w-[250px] py-[9.5px]' onClick={adicionarcategoriasColaboradoresClick}>Criar Categoria Colaborador</button>
                        </div>}
                    </div>
